...
export class WineTypeHandlers {
    ...
    deleteWineTypeById() {
        return async (req, res) => {
            ...
            const result = await this.orm.wineTypes.delWineTypeById(id);
    ...
    postWineType() {
        return async (req, res) => {
            try {
                const wineType = await this.orm.wineTypes.postWineType(req.body);
    ...
    getWineTypes(): (req, res) => Promise<void> {
        return async (_, res) => {
            try {
                const wineTypes = await this.orm.wineTypes.findWineTypes();
